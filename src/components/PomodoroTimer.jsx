...
const DEFAULT_DURATIONS = { focus: 25, break: 5, long: 15 }
const MODE_LABELS = { focus: 'Focus', break: 'Break', long: 'Long' }
...
export default function PomodoroTimer({ onPomComplete, pomCount = 0 }) {
  ...
  return (
    <div style={{
      ...
      <div style={{ padding: '10px 16px 0' }}>
        <div style={{
          display: 'flex', background: '#f5f1fc',
      ...
      <div style={{
        ...
        <div style={{ position: 'relative', width: 140, height: 140 }}>
          ...
          <div style={{
            ...
            <span style={{
              ...
              fontSize: 26, fontWeight: 500, color: '#5c4a7e',
        ...
        <p style={{
          ...
          margin: '6px 0 12px', textAlign: 'center',
        }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                  <input
                    ...
                    style={{
                      ...
                      borderRadius: 6, padding: '4px 0', color: '#2d2a3e',
                      outline: 'none',
                    }}
