export const DEFAULT_SCHEDULE = [
  { id: 's1',  start: '08:00', end: '08:30',  label: 'Warm Up',       subtitle: 'Review notes, plan today\'s targets',               isBreak: false, icon: 'sun',        durationLabel: '30m'    },
  { id: 's2',  start: '08:30', end: '10:30',  label: 'DSA Block 1',   subtitle: 'LeetCode — arrays, strings, sliding window',         isBreak: false, icon: 'code',       durationLabel: '2h'     },
  ...
  { id: 's6',  start: '13:15', end: '14:45',  label: 'Mock OA',       subtitle: 'Timed simulation — 3 problems, 90 min, no hints',   isBreak: false, icon: 'terminal-2', durationLabel: '1h 30m' },
  ...
  { id: 's9',  start: '16:00', end: '16:45',  label: 'Applications',  subtitle: 'Cisco, Atlassian, NetApp, Intuit — apply + track',  isBreak: false, icon: 'send',       durationLabel: '45m'    },
  { id: 's10', start: '16:45', end: '17:00',  label: 'Break',         subtitle: '',                                                 isBreak: true,  icon: 'coffee',     durationLabel: '15m'    },
  { id: 's11', start: '17:00', end: '17:45',  label: 'Review & Doubts', subtitle: 'Fix mistakes, write what you learned',           isBreak: false, icon: 'pencil',     durationLabel: '45m'    },
]
...
export const DEFAULT_RESOURCES = [
  ...
  { id: 'r5', label: 'Tracker',    url: 'https://job-searcher-z2f1.vercel.app/', icon: 'briefcase'     },
  { id: 'r6', label: 'Resume',     url: 'https://www.overleaf.com/project',      icon: 'file-text'     },
]
